...
export function Joystick({ mode, disabled, className, onVelocities }: JoystickProps) {
  ...
  return (
    <div className={cn("relative size-20 rounded-lg", className)}>
      <div
        className={cn(
          "text-foreground absolute inset-0 grid grid-cols-[auto_40px_auto] grid-rows-[auto_40px_auto] rounded-lg border border-muted-foreground transition-[colors,opacity] opacity-100",
        ...
        <div className="relative">
          ...
          >
            <motion.div
              ...
              onDragEnd={onDragEnd}
              className={cn(
                "bg-card pointer-events-auto size-10 cursor-grab touch-none rounded-full border border-muted-foreground transition-colors will-change-transform active:cursor-grabbing",

        ...
        <div className="relative">
          ...
          >
            <motion.div
              ...
              onDragEnd={onDragEnd}
              className={cn(
                "bg-accent-foreground pointer-events-auto size-10 cursor-grab touch-none rounded-full border transition-colors will-change-transform active:cursor-grabbing",

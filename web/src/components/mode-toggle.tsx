...
export function ModeToggle({
  ...
  return (
    <div className="border-accent-foreground/50 bg-background flex h-10 w-[250px] items-center justify-center rounded border p-1">
      <div className="relative grow">
        <motion.div
          animate={{ x: mode === 'view' ? 0 : '100%' }}
          transition={{ duration: 0.2, ease: 'easeInOut' }}
          className="bg-accent-foreground/10 text-primary-foreground border-primary-foreground/30 absolute z-10 h-full w-1/2 rounded border"
        />
        <div className="grid grid-cols-2">
          <button
            ...
            className={cn(
              `relative z-20 col-start-1 flex flex-1 cursor-pointer items-center justify-center rounded px-3 py-1.5 font-mono text-xs transition-colors`,
          ...
          <button
            ...
            className={cn(
              `relative z-20 col-start-2 flex flex-1 cursor-pointer items-center justify-center gap-2 rounded px-3 py-1.5 font-mono text-xs transition-colors`,

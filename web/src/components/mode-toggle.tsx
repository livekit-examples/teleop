...
export function ModeToggle({
  ...
  return (
    <div className="border-accent-foreground/50 bg-background h-10 w-[250px] items-center justify-center rounded-md border p-1">
      <div className="grid grid-cols-2 rounded">
        <button
          ...
          className={cn(
            ...
            mode === "view"
              ? "bg-accent-foreground/10 text-primary-foreground border-primary-foreground/30 border"
